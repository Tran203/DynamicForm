...
namespace DynamicForm.Controllers
{
    public class OptionsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,QuestionId,Text,OrderIndex")] Option option)
        {
            ...
            ViewData["QuestionId"] = new SelectList(_context.Questions, "Id", "Text", option.QuestionId);
            return View(option);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,QuestionId,Text,OrderIndex")] Option option)
        {
            if (id != option.Id)
            {
                return NotFound();
